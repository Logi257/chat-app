          ...
          >
            ...
            <div className="flex flex-col leading-5">
              ...
              {onlineUsers.includes(user._id) ? (
                <span className="text-green-400 text-[11.5px]">Online</span>
              ) : (
                <span className="text-neutral-400 text-[11.5px]">Offline</span>
              )}
            </div>

            {unseenMessages[user._id] > 0 && (
              <p className="absolute right-4 top-4 text-sm h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50">
